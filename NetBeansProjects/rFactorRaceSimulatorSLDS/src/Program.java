...
public class Program extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jFrame1.setMinimumSize(new java.awt.Dimension(634, 705));
        ...
        jFrame1Layout.setVerticalGroup(
            ...
            .addGroup(jFrame1Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(raceresults, javax.swing.GroupLayout.PREFERRED_SIZE, 599, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(18, 18, 18)
    ...
    public void simulation_test() throws InterruptedException {
        ...
        for(int i = 0; i < CAMPEONATO.get_parrilla().size(); ++i) 
        {
            ...
            if(dnf == 1) { //accident
                ...
                //1.- Se calcula el rendimiento del piloto para la carrera
                //2.- Se determina la distancia al líder
                
                if(comparacion1) { //Muy buena carrera
                    if(masexacto <= perf1) { 
                ...
                else if(comparacion2) { //Buena carrera
                    if(perf1 > perf2) { 
                ...
                else if(comparacion3) { //Carrera regular
                    if(perf1 > perf2) { 
                        randomNum = ThreadLocalRandom.current().nextDouble(18.0, 18.5);
                    }
                    else if(perf2 > perf3) { 
